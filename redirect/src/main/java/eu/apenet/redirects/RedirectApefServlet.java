...
public class RedirectApefServlet extends HttpServlet {

	private static Logger LOGGER = Logger.getLogger(RedirectApefServlet.class);
...
//		pw.close();
		...
		Redirection redirection = RedirectService.instance().handleRequest(request, Redirection.REDIRECTION_TYPE_APEF);
