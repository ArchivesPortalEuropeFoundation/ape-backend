...
public class RedirectDptServlet extends HttpServlet {

	private static Logger LOGGER = Logger.getLogger(RedirectDptServlet.class);
...
//		pw.close();
		...
		Redirection redirection = RedirectService.instance().handleRequest(request, Redirection.REDIRECTION_TYPE_DPT);
