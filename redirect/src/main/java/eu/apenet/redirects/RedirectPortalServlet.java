...
public class RedirectPortalServlet extends HttpServlet {

	private static Logger LOGGER = Logger.getLogger(RedirectPortalServlet.class);
...
//		pw.close();
		...
		Redirection redirection = RedirectService.instance().handleRequest(request, Redirection.REDIRECTION_TYPE_PORTAL);
