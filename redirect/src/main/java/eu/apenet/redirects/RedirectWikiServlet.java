...
public class RedirectWikiServlet extends HttpServlet {

	private static Logger LOGGER = Logger.getLogger(RedirectWikiServlet.class);
...
//		pw.close();
		...
		Redirection redirection = RedirectService.instance().handleRequest(request, Redirection.REDIRECTION_TYPE_WIKI);
