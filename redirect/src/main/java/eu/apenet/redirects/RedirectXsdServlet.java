...
public class RedirectXsdServlet extends HttpServlet {

	private static Logger LOGGER = Logger.getLogger(RedirectXsdServlet.class);
...
//		pw.close();
		...
		Redirection redirection = RedirectService.instance().handleRequest(request, Redirection.REDIRECTION_TYPE_XSD);
